...
default:
	@echo "-- VERILATE ----------------"
	$(VERILATOR) $(VL_FLAGS) sim_main.cpp fe_stage.v de_stage.v mem_stage.v wb_stage.v agex_stage.v divider.v external_alu_wrapper.v FU_stage.v multiplier.v -CFLAGS '$(CXXFLAGS)'
	@echo "-- COMPILE -----------------"
